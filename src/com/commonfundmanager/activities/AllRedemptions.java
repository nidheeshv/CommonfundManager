...
public class AllRedemptions extends Activity {
		...
		protected void onCreate(Bundle savedInstanceState) {
			...
			setContentView(R.layout.allredemptions);
		
		try{	
		dbHandler = new DbHandler(getApplicationContext());
			
		ArrayList<Transaction> transactionList=dbHandler.getAllRedemptions();
		Log.d("Claim","transactionList size: "+transactionList.size());
		...
		myTable+="</table>";
		Log.d("All Claim","myTable : "+myTable);
		depositwebview = (WebView) findViewById(R.id.redemptions_info_table);
	//	Log.d("All deposits 2","myTable : "+myTable);
		...
		//  mwebview.setWebViewClient(new WebViewClient());
			...
			Log.d("All Claim","error : "+e.getMessage()+e.getStackTrace()+e.getCause());
		}
		}
